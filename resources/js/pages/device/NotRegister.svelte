...
<LayoutTop>
    ...
    <div
        class="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-950 dark:to-pink-900 flex min-h-svh flex-col items-center justify-center gap-6 sm:gap-8 p-4 sm:p-6 md:p-10"
    >
        <div class="w-full max-w-md mx-auto">
            <div
                class="flex flex-col items-center gap-4 sm:gap-6 text-center px-2"
            >
                <!-- Icon -->
                <div
                    class="flex size-14 sm:size-16 items-center justify-center rounded-full bg-pink-500/10 border-2 border-pink-500/20"
                >
                    <SmartphoneIcon
                        class="size-7 sm:size-8 text-pink-600 dark:text-pink-400"
                    />
                </div>
                ...
                <div class="space-y-2">
                    ...
                    >
                        ...
                        Silakan daftarkan perangkat Anda terlebih dahulu untuk
                ...
                <div class="mt-2 sm:mt-4">
                    <FieldDescription
                        class="text-xs sm:text-sm text-pink-600 dark:text-pink-400"
                    >
                        Proses pendaftaran hanya perlu dilakukan sekali per
                        perangkat
                    </FieldDescription>
                </div>
            </div>

<script lang="ts">
	...
	let { class: className = '', spotlightColor = 'rgba(255, 255, 255, 0.25)', children, ...rest }: Props = $props();
...
<div
	...
	class={cn('relative rounded-3xl border border-neutral-800 bg-neutral-900 overflow-hidden p-8',className)}
	{...rest}
>
	<div
